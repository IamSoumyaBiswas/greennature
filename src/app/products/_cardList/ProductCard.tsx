...
const ProductCard = () => {
  return (
    ...
    <div className="max-w-screen-xl pb-[48px]  sm:px-2 md:px-2 lg:px-4 border-0 px-2 border-orange-700   gap-[16px]   grid grid-cols-2 p-2 sm:grid-cols-3 md:grid-cols-3 lg:grid-cols-3 place-items-center">
      {products.map((product) => (
        <ProductCardWithButton key={product._id} {...product} />
      ))}
    </div>
