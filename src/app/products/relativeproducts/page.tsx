...
const page = () => {
  return (
    <div className="max-w-screen-xl pb-[48px] lg:my-[0px] md:my-[0px] sm:my-[0px] my-[0px] sm:px-8 md:px-8 lg:px-24 container border-0 px-4 border-orange-700 mx-auto  gap-[16px]   grid grid-cols-2 p-2 sm:grid-cols-3 md:grid-cols-3 lg:grid-cols-4 place-items-center">
