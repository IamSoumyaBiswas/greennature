...
const ProductCardWithButton = ({
    ...
    return (
        ...
        <Link href={productCardLink}>
                <div className="relative w-full lg:h-56 md:h-48 h-40 rounded-md overflow-hidden">
                    <Image
                        src={productImage}
            ...
            <div className="lg:flex flex items-center justify-center lg:flex-row flex-col w-full lg:gap-[4px] gap-2 mt-1 font-marcellus border-none border-blue-500">
            <Button buttonName="Buy Now" type={ButtonType.Primary as ButtonType} fontSize='text-xs' />
            <Button buttonName="Add to cart" type={ButtonType.OutLine as ButtonType} fontSize='text-xs' />
...
// object-fit lg:h-52 md:h-52  object-cover w-full rounded-md flex items-center
